...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        itemMachin.addProduct(new HotDrink("Tea", 200.0, 250, 38 ));
        itemMachin.addProduct(new HotDrink("Green Tea", 220.0, 250, 38 ));
        itemMachin.addProduct(new HotDrink("Coffee", 260.0, 250, 38 ));
        itemMachin.addProduct(new HotDrink("Latte", 295.0, 250, 38 ));
